...
public class ServiceServer {
    ...
    public void start() throws IOException, InterruptedException {
        ...
        DatagramPacket linkerSubscribePacket = new DatagramPacket(serviceNumber, serviceNumber.length, InetAddress.getByName(linkers[linkerNumber].getIp()),  linkers[linkerNumber].getPort());
